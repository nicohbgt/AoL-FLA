...
public class Agya implements Vehicle {
    ...
    public Agya(String color, String plateNumber, int productionYear, String chassisNumber,
        ...
        this.vehicleType = "Hatchback"; // Sesuaikan jika ada varian lain
        ...
        this.fuelLevel = 33000; // Sesuai permintaan Anda, diasumsikan 33000 unit internal
    ...
    public int getFuelLevel() {
        return (int) ((fuelLevel / 33000.0) * 100); // Konversi ke persentase berdasarkan 33000 unit
    }
    @Override
    public double getFuelLevelLiters() {
        return fuelLevel / 1000.0; // Mengasumsikan 33000 unit internal = 33 liter
    }
    @Override
    ...
    public void drive(double distanceKm) {
        if (isEngineOn && !isLocked) {
            mileage += 20; // Simulasi driving seperti yang Anda inginkan
    ...
    public void refuel() {
        if (fuelLevel < 33000) {
            fuelLevel = 33000; // Refuel to full (33000 unit internal)
    ...
    public void setFuelLevel(double fuelLevel) {
        this.fuelLevel = Math.max(0, Math.min(fuelLevel, 33000.0)); // Batas maksimum 33000 unit
    }
