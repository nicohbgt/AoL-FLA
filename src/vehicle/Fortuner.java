...
public class Fortuner implements Vehicle {
    ...
    public Fortuner(String color, String plateNumber, int productionYear, String chassisNumber,
        ...
        this.brand = "Toyota";
        this.model = "New Fortuner";
        this.fuelType = "Diesel"; // Sesuaikan jika ada varian Bensin
        this.transmissionType = "6 Speed Automatic Transmission";
        this.vehicleType = "Sport Utility Vehicle (SUV)";
        ...
        this.fuelLevel = 80000; // Sesuai permintaan Anda, diasumsikan 80000 unit internal
    ...
    public int getFuelLevel() {
        return (int) ((fuelLevel / 80000.0) * 100); // Konversi ke persentase berdasarkan 80000 unit
    }
    @Override
    public double getFuelLevelLiters() {
        return fuelLevel / 1000.0; // Mengasumsikan 80000 unit internal = 80 liter
    }
    @Override
    ...
    public void drive(double distanceKm) {
        if (isEngineOn && !isLocked) {
            mileage += 12; // Simulasi driving seperti yang Anda inginkan
    ...
    public void refuel() {
        if (fuelLevel < 80000) {
            fuelLevel = 80000; // Refuel to full (80000 unit internal)
    ...
    public String getStatus() {
        return model + " Status: " + (isEngineOn ? "Running" : "Stopped") + ", Fuel Level: " + getFuelLevel() + "%, Mileage: " + mileage + " km";
    }
    ...
    public void setFuelLevel(double fuelLevel) {
        this.fuelLevel = Math.max(0, Math.min(fuelLevel, 80000.0)); // Batas maksimum 80000 unit
    }
