...
public class Rush implements Vehicle {
    ...
    public Rush(String color, String plateNumber, int productionYear, String chassisNumber,
        ...
        this.transmissionType = "4 Speed Automatic Transmission";
        ...
        this.fuelLevel = 45000; // Sesuai permintaan Anda, diasumsikan 45000 unit internal
    ...
    public int getFuelLevel() {
        return (int) ((fuelLevel / 45000.0) * 100); // Konversi ke persentase berdasarkan 45000 unit
    }
    @Override
    public double getFuelLevelLiters() {
        return fuelLevel / 1000.0; // Mengasumsikan 45000 unit internal = 45 liter
    }
    @Override
    ...
    public void drive(double distanceKm) {
        if (isEngineOn && !isLocked) {
            mileage += 14; // Simulasi driving seperti yang Anda inginkan
    ...
    public void refuel() {
        if (fuelLevel < 45000) {
            fuelLevel = 45000; // Refuel to full (45000 unit internal)
    ...
    public String getStatus() {
        return "Rush Status: " + (isEngineOn ? "Running" : "Stopped") + ", Fuel Level: " + fuelLevel + "%, Mileage: " + mileage + " km";
    }
    ...
    public void setFuelLevel(double fuelLevel) {
        this.fuelLevel = Math.max(0, Math.min(fuelLevel, 45000.0)); // Batas maksimum 45000 unit
    }
