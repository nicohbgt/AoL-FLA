...
public class Yaris implements Vehicle {
    ...
    public Yaris(String color, String plateNumber, int productionYear, String chassisNumber,
        ...
        this.brand = "Toyota";
        this.model = "New Yaris";
        this.fuelType = "Gasoline";
        this.transmissionType = "7 Speed Continuously Variable Transmission (CVT)";
        ...
        this.fuelLevel = 36000; // Sesuai permintaan Anda, diasumsikan 36000 unit internal
    ...
    public int getFuelLevel() {
        return (int) ((fuelLevel / 36000.0) * 100); // Konversi ke persentase berdasarkan 36000 unit
    }
    @Override
    public double getFuelLevelLiters() {
        return fuelLevel / 1000.0; // Mengasumsikan 36000 unit internal = 36 liter
    }
    @Override
    ...
    public void refuel() {
        if (fuelLevel < 36000) {
            fuelLevel = 36000; // Refuel to full (36000 unit internal)
    ...
    public void setFuelLevel(double fuelLevel) {
        this.fuelLevel = Math.max(0, Math.min(fuelLevel, 36000.0)); // Batas maksimum 36000 unit
    }
