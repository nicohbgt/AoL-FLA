...
public class InnovaReborn implements Vehicle {
    ...
    public InnovaReborn(String color, String plateNumber, int productionYear,
        ...
        this.brand = "Toyota";
        this.model = "New Kijang Innova";
        this.fuelType = "Solar"; // Sesuaikan jika ada varian Bensin
        this.transmissionType = "6 Speed Automatic Transmission"; // Sesuaikan jika ada varian lain
        ...
        this.fuelLevel = 55000; // Sesuai permintaan Anda, diasumsikan 55000 unit internal
    ...
    public int getFuelLevel() {
        return (int) ((fuelLevel / 55000.0) * 100); // Konversi ke persentase berdasarkan 55000 unit
    }
    @Override
    public double getFuelLevelLiters() {
        return fuelLevel / 1000.0; // Mengasumsikan 55000 unit internal = 55 liter
    }
    @Override
    ...
    public void refuel() {
        if (fuelLevel < 55000) {
            fuelLevel = 55000; // Refuel to full (55000 unit internal)
    ...
    public void setFuelLevel(double fuelLevel) {
        this.fuelLevel = Math.max(0, Math.min(fuelLevel, 55000.0)); // Batas maksimum 55000 unit
    }
