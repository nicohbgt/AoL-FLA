...
public class Avanza implements Vehicle {
    ...
    public Avanza(String color, String plateNumber, int productionYear, String chassisNumber,
        ...
        this.brand = "Toyota";
        this.model = "All New Avanza";
        this.fuelType = "Gasoline";
        this.transmissionType = "5 Speed M/T"; // Sesuaikan jika ada varian lain
        ...
        this.fuelLevel = 43000; // Sesuai permintaan Anda, diasumsikan 43000 unit internal
    ...
    public int getFuelLevel() {
        return (int) ((fuelLevel / 43000.0) * 100); // Konversi ke persentase berdasarkan 43000 unit
    }
    @Override
    public double getFuelLevelLiters() {
        return fuelLevel / 1000.0; // Mengasumsikan 43000 unit internal = 43 liter
    }
    @Override
    ...
    public void refuel() {
        if (fuelLevel < 43000) {
            fuelLevel = 43000; // Refuel to full (43000 unit internal)
    ...
    public void setFuelLevel(double fuelLevel) {
        this.fuelLevel = Math.max(0, Math.min(fuelLevel, 43000.0)); // Batas maksimum 43000 unit
    }
